...
/* reference velocity is set to 100 mph */
double ref_v = 100.0;
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    // the Solver function below.
      ...
      for(int t = 1; t < N; t ++)
      {
          ...
          /* derivative */
          AD<double> psides0 = CppAD::atan(coeffs[1] + 2 * coeffs[2] * x0 + 3 * CppAD::pow(x0,2));
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  /* The state are x,y,psi,v,cte,epsi, N timesteps */
  /* The actuators are delta, a , (N-1) timesteps*/
  ...
  /* Set the upper and lower limits of delta and a */
